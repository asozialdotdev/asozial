...
function ParentPostLoading() {
  return (
    <PageContainer className="w-full max-w-screen-md">
      <section className="-mt-10 w-full gap-1 rounded-md border-zinc-300 px-8 py-10 hover:bg-zinc-100 dark:border-zinc-600 dark:shadow-neutral-700/30 dark:hover:bg-zinc-800">
