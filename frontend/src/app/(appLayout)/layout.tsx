  ...
  return (
    <>
      ...
      <div className="relative flex h-full w-full overflow-x-hidden bg-light px-4 dark:bg-dark">
        <aside
          className={`absolute bottom-0 left-0 top-0 z-40 h-full w-[18rem] border-y border-dark bg-gray-100 transition-transform duration-300 ease-in-out dark:border-light dark:bg-zinc-900 ${
            isUserSidebarOpen
